...
A1. July 14th and October 4th had the most calls of any day that year, with 23. I got 329 rows, which leads me to believe there were some days that got no calls.
...
A2. Weekends and Mondays have the most calls
...
A3. 4540 Silver Spring Road had by far the most with 36, others having no more than 13. It may be possible there was not unity in how the locations were entered into the data, therefore causing some locations to not be properly grouped together here.
...
A4. Do weekends and Mondays have more overdose calls? Why or why not?
