...
**A1. Failing is the leading word and I think that the leading words describe the most common words used to describe the sanctions and hand out the sanctions. After adding to the stop words trust is the top word which could hint at something to do with the most common complaint**
...
**A2. Attorney trust account is the top trigram, appearing 343 times. An attorney trust account is where a lawyer can handle large sums of money for a client, earning interest on that money in that account.**
