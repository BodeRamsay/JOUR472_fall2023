...
media_expenses_clean |> group_by(payee_name) |> summarize(sum(amount)) |> filter(str_detect(payee_name, 'FACEBOOK'))
...
media_expenses_clean |> filter(str_detect(payee_clean, 'Facebook')) |> 
...
**A2. The top spenders running for office were typically running for governor, hence the large amounts of money spent. Others might be spending for a campaign for Congress. There was also spendors like the Working Families Party, who were putting money towards a cause. The ads of the top spender are all political.**
...
**A3. Wes Moore, winner of the election, and Tom Perez, runner up in the election, are surprisingly missing from the top spenders list. These candidates did use Facebook ads according to the Facebook library. SKDK was the biggest recipients of money from Wes Moore's campaign.**
...
**A4. It is very different from the list in A1. The whole list has completely changed, with us now being able to see the top to candidates, Wes Moore and Tom Perez in the top ten as well as a bunch of other new committees. Ashwani Jain and Peter Franchot appear to have used all of their money towards Facebook ads**
...
**A5 According to these results, it would seem that the use of Facebook ads does not translate to election success. Other candidates who spent much more on different advertising seemed to do much better in the election than those who spent a lot (or all) of their money on Facebook ads.**
