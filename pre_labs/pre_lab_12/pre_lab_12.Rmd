...
**Task** Run the following code and describe the dataframe it outputs. **Answer It gives us a bunch of press releases and the url to these releases**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer It gets rid of duplicates in the list, extracting only one instance of the word being used**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer It converted everything to lowercase and removed all punctuation in the text column of the text of the releases. It put all of the unique words of each release it into a table where each word is put into its own row in order**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer It shows a count of all the words used in the Cardin releases, which would be much more interesting if we were to sort for words outside of the normal articles and transition words like "the" or "and"**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer It is more interesting before because it shows the percentage of words being used in each release and it is not just short common words, but actual words of importance, "health" being at the top.**
...
**Task** Run the following code and describe the results. **Answer It gives us the unique words for each year from 2021-2023, the same way the unique words got the words before.**
...
**Task** Run the following code and describe the results. **Answer This gives us the top 10 bigrams from before 2022 in the releases, "covid 19" being the most used one. This time it uses a group of two words instead of just one word to count them, hence it being about bigrams**
...
**Task** Run the following code and describe the results. **Answer This filters for releases that are from 2022 but does the same thing as the last bit of code otherwise**
...
**Task** Run the following code and describe the results. **Answer This does the same thing as the previous two code blocks but filters for the 2023 releases**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer This counts the number of verbs and adjectives and labels the word as positive or negative for each year from 2021-2023. For the sentiments that I see, they mostly make sense in regards to whether that word is positive or negative. The only comment I would have is that some words can be positive or negative depending on the situation**
