...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **There is two extra columns being the mean and median of the seats in each class.**
...
**Answer This time it grouped everything by departments instead of terms and it included rows for the max/min seats. It continued to organize the data by the most total seats per department**
