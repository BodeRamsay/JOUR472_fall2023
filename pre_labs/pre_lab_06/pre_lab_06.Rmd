...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer For the most part yes. They all have the same categories just one of the total columns isn't in all caps like the others.**
...
**Answer The registration for Democrats and others increases, which could signify a population increase**
...
**Task** Run the following code to join Maryland population data and the 2022 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **Answer There are 24, which is the number of counties so that is okay.**
...
**Task** Load the Maryland demographic data and examine it. What kind of information does it contain? **Answer It contains information about the population of different demographics in each county**
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer Prince George's county has the highest percentage population of people who are 18+ and Black. The percentage of Democrats in that county is just over 77%.**
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer Howard county has the highest percentage of 18+ Asian people, it has a much lower percentage of Democrats with 52.6%. The percentage of Asian people is also generally way lower than the percentage of Black people in all of these counties**
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **Answer Double**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Answer Character**
