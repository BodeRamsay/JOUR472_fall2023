...
**Task** Run the following code and describe the dataframe it outputs. **Answer Gives data on each state's education spending pre student, the economic growth of the state, the population change of the state and the winner of the 2020 election**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer Gives us a scatterplot comparing the population chacge and the economic growth. There is not much of a pattern in the scatterplot, weak correlation.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer Gives us a scatterplot comparing the education spending per student and the economic growth. Again there is very weak correlation.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer It gives us some correlation coefficients based off comparing the columns to different columns of the data. It allows us to see the relationship between every part of the data.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer Gives us extra information about the correlation between spending per student and population change like the p-value, t-test, and more.Answer is statistically significant according to the p-value.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer Gives us some extra information about the correlation between education spending per student and economic growth like the p-value, t-test, and more. Answer is not statistically significant according to the p-value.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer This gives the averages of each column based on who won the election in that state**
...
**Task** Run the following code. Describe the output. What do you see? **Answer I see many of the same statistics from before and see that the p-value is not statistically significant for the population change.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer I see the same grouping of statistics from the previous questions for spending per student and see that the p-value shows that it is statistically significant.**
