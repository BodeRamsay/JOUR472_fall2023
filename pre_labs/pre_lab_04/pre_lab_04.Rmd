...
**Answer: The grantee names should be cleaned so that any possible duplicates are prevented and they are more easily readable, as many of the names might start off with similar or even the same words.**
...
**Answer: It put some grantee's into all uppercase to standardize the data and make it group together better.**
...
**Answer: I do not know why but nothing changed for my code. Will ask about it in class to see what might have happened.**
...
**Answer: Again I can't see the changes that the merge function did, so I cannot tell whether the changes it made varied substantially.**
