...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer Making the new dataset and then the month column, grouping by that month and then adding a column that counts the total number of calls from that month and arranging the data in descending order to see which month has the most calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer An empty gray box**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see a vertical bar chart that goes in order of month, showing the count of calls from that month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer This time it is the same chart ordered in ascending order**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer We have flipped the bar chart to be horizontal now, swapping the x and y axis but keeping the ascending order**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer This removed the gray background, instead making it white**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer This gave a different background from the last version of the chart**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer there is now a title to the graph with shorter names to the x and y axis. It took the theme from the last codeblock and cleaned it up a bit making it more official**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see the total calls for each date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer It is a very sporadic line chart depicting the number of calls on each day of the year the data was taken**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The weeks have been added to the x axis, making it even harder to read the graph.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer It is still the weeks on the x axis but this time instead of the text overlapping they have them written diagonally to make it more coherent to the reader of the graph.**
